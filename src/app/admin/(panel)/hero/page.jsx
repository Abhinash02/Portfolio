...
//           url: "",
//           icon: "",
//           order: (prev.socialLinks?.length || 0) + 1,
//         },
//       ],
//     }));
//   };
...
//           label: "",
//           value: "",
//           order: (prev.highlights?.length || 0) + 1,
//         },
//       ],
//     }));
//   };
...
//           onChange={(e) => setForm((prev) => ({ ...prev, availabilityText: e.target.value }))}
...
//                 Upload your resume PDF directly from admin
//               </p>
//             </div>
...
//           {form.highlights.map((item, index) => (
//             <div key={index} className="grid gap-3 rounded-2xl border border-white/10 p-4 md:grid-cols-4">
//               <input
//                 value={item.label || ""}
//                 onChange={(e) => updateHighlight(index, "label", e.target.value)}
//                 placeholder="Card label"
