...
// //         <FadeUp>
// //           <p className="mb-3 text-sm uppercase tracking-[0.35em] text-cyan-400">Who I Am</p>
// //           <h2 className="mb-8 text-4xl font-black md:text-5xl">About Me</h2>
// //         </FadeUp>

// //         <FadeUp delay={0.1}>
// //           <div className="glass rounded-[2rem] p-8 md:p-10">
// //             <p className="max-w-4xl text-lg leading-8 text-white/70">
// //               {about?.content || "MERN Stack Developer with a focus on scalable web applications, authentication systems, dashboards, and responsive interfaces."}
// //             </p>
// //           </div>
// //         </FadeUp>
// //       </div>
...
//             <div className="glass group relative overflow-hidden rounded-[2rem] border border-white/10 p-6 shadow-[0_20px_60px_rgba(2,6,23,0.35)] transition duration-500 hover:-translate-y-1 hover:border-cyan-400/20 hover:shadow-[0_24px_70px_rgba(34,211,238,0.10)] md:p-10">
...
//                 <p className="max-w-4xl text-justify text-base leading-8 text-white/75 md:text-lg">
//                   {about?.content ||
...
//                   {/* <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm transition duration-300 hover:bg-white/8">
//                     <p className="text-xs uppercase tracking-[0.22em] text-cyan-300">Focus + CORE + GOAL</p>
//                    <h3 className="mt-1 text-lg font-semibold text-white md:text-xl">Full Stack, MERN + Next.js, Clean Scalable UI</h3>
//                   </div> */}
//                   <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
//   <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm transition duration-300 hover:bg-white/8">
//     <p className="text-xs uppercase tracking-[0.22em] text-cyan-300">Focus + CORE + GOAL</p>
//     <h3 className="mt-1 text-sm font-medium leading-6 text-white sm:text-base md:text-lg lg:text-xl">
...
//                   {/* <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm transition duration-300 hover:bg-white/8">
//                     <p className="text-xs uppercase tracking-[0.22em] text-cyan-300">Core</p>
//                     <h3 className="mt-2 text-lg font-bold text-white"></h3>
//                   </div>
...
//               <div className="glass rounded-[1.75rem] border border-white/10 p-5 transition duration-300 hover:border-cyan-400/20 hover:bg-white/6">
//                 <p className="text-sm uppercase tracking-[0.24em] text-cyan-300">Experience</p>
//                 <h3 className="mt-3 text-3xl font-black text-white">MERN</h3>
...
//                 <h3 className="mt-3 text-3xl font-black text-white">Modern</h3>
//                 <p className="mt-2 text-justify text-sm leading-7 text-white/60">
          ...
          <div className="mt-8 grid gap-6 md:gap-8 lg:grid-cols-12 lg:items-start">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:col-span-4 lg:grid-cols-1 lg:sticky lg:top-24">
              <div className="glass rounded-[1.75rem] border border-white/10 p-5 transition duration-300 hover:border-cyan-400/20 hover:bg-white/6 md:p-6">
                <p className="text-sm uppercase tracking-[0.24em] text-cyan-300">Experience</p>
                <h3 className="mt-3 text-2xl font-black text-white md:text-3xl">MERN</h3>
                <p className="mt-2 text-justify text-sm leading-7 text-white/60">
                  Building responsive dashboards, auth flows, APIs, and production-ready features.
                </p>
              </div>
